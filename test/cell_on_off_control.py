...
class Scanning:
    ...
    def read_hw_info(self, cell_port):
        ...
        #         unix_time = cell_info.get_time_when_file_create()
        #     else:
        #         valid = False
        #         bad_sector_num = 0
        #         unix_time = 0
        ...
        #     }
        #
        #     self.cell_df = self.cell_df.append(cell_dict, ignore_index=True)
        #     self.cell_df = self.cell_df.astype(dtypes)
        #
        # return self.cell_df
    ...
    def main(self, open_cell_num_position):
        ...
        # res = self.transmit_command_to_hub_mcu(hub_com_port, ENTER_CELL_BL_MODE, str(b'\xca`'))
        #
        # if b'\xca`' in res:
        #     print("Enter BL mode done")
        # else:
        #     print("Enter BL mode fail")
        #
        # time.sleep(1)
        #
        # if self.cell_num_com_open(hub_com_port, open_cell_num_position, "ACT OK!"):
